...
export const FileUploadDropzone = React.forwardRef(
  function FileUploadDropzone(props, ref) {
    ...
    return (
      <ChakraFileUpload.Dropzone ref={ref} {...rest} className='test'>
        <Box as={LuUpload} fontSize="xl" color="fg.muted" />
...
const FileUploadItem = React.forwardRef(function FileUploadItem(props, ref) {
  ...
  return (
    ...
    >
      ...
      <Box as={LuFile} fontSize="xl" color="fg.muted" />
...
export const FileUploadList = React.forwardRef(
  function FileUploadList(props, ref) {
    ...
    return (
      <ChakraFileUpload.ItemGroup ref={ref} {...rest} className='fileContainer'>
        {acceptedFiles.map((file) => {
          const myArray = new Uint32Array(10);
          const key = crypto.getRandomValues(myArray)
          return(
          <FileUploadItem
            key={key}
            file={file}
